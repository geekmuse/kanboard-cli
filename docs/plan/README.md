...
| [05-milestone-3-extended.md](05-milestone-3-extended.md) | Tasks 28–41 (P2): files, metadata, permissions, groups, actions, time tracking, me, application, workflow system, example workflow |
...
| **Kanboard API methods to cover** | 158 across 24 categories |
